	...
	return (
		<>
			<section>
				...
				>
					<div className="flex h-12 w-12 items-center justify-center rounded-full border border-solid border-[color:var(--sl-border)] bg-[var(--input)]">
						<Image src="/icons/bag.png" alt="Bag" width={32} height={32} />
					</div>

					<div className="flex-1">
						<h3 className="text-[11px] text-[var(--sl-text)] sm:text-[1rem]">
							What&apos;s in your bag?
						</h3>

						<p className="text-xs lg:text-sm text-[var(--sl-text-muted)]">
